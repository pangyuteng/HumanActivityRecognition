...
class UCF101Dataset_testset(dataset.Dataset):
    ...
    def __init__(self, data_path, split, which_set,
        ...
        self.data = data = rng.normal(size=(64*3, self.nb_x,self.nb_y,self.nb_t))
        self.labels = np.random.binomial(self.nbTags-1, 0.5, (1000, 1))
